"""This file was directly imported from python-decertifi."""
...
def _register_bootstrap_functions():
    ...
    # will be executed after all module search path has been set up.

    # This will register the patches
    # noinspection PyUnresolvedReferences
    from . import wrapt_certifi, wrapt_pip  # noqa: F401
